...
XML_PATH = os.path.join(parent_dir, '../assets/biped_no_yaw/xmls/biped_RL.xml')
# XML_PATH = os.path.join(parent_dir, 'robot_learning/src/assets/biped_no_yaw/xmls/biped_RL.xml')
