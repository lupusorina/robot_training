...
XML_PATH = '../assets/biped/xmls/scene_mjx_feetonly_flat_terrain.xml'
ROOT_BODY = "base_link"
...
class Biped():
  ...
  def _post_init(self) -> None:
    ...
    ffe_indices = []
    for side in ["L", "R"]:
      ffe_indices.append(self._mj_model.joint(f"{side}_ANKLE").qposadr[0] - 7)
    ...
    hip_ids = [0, 1, 2, 5, 6, 7] # TODO fix this hardcoded thing
